...
class Card extends GameObject_1.default {
    ...
    draw(color = "white") {
        ...
        if (color == "red")
            ...
            Canvas_1.default.image(common_1.getImage("CardKarma"), this.position.x, this.position.y, this.width, this.height);
        else
            Canvas_1.default.image(common_1.getImage("CardVolatile"), this.position.x, this.position.y, this.width, this.height);
    }
}
