...
class Card extends GameObject_1.default {
    ...
    draw(color = "white") {
        ...
        if (color == "red")
            Canvas_1.default.image(common_1.getImage("CardATK1"), this.position.x, this.position.y, this.width, this.height);
        else if (color == "redred")
            Canvas_1.default.image(common_1.getImage("CardATK2"), this.position.x, this.position.y, this.width, this.height);
        else if (color == "blue")
            Canvas_1.default.image(common_1.getImage("CardHP1"), this.position.x, this.position.y, this.width, this.height);
        else if (color == "blueblue")
            Canvas_1.default.image(common_1.getImage("KarmaCard"), this.position.x, this.position.y, this.width, this.height);
        else
            Canvas_1.default.image(common_1.getImage("VolatileCard"), this.position.x, this.position.y, this.width, this.height);
    }
}
