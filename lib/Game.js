...
class Game {
    ...
    render() {
        ...
        Canvas_1.default.background("rgb(30, 20, 20)");
        let backgroundY = 150;
        Canvas_1.default.rect(0, backgroundY, Canvas_1.default.canvas.clientWidth, Canvas_1.default.canvas.clientHeight);
        Canvas_1.default.fillStyle("rgb(100, 100, 100");
        Canvas_1.default.fill();
